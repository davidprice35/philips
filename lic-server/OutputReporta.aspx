<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutputReporta.aspx.cs" Inherits="competitive_info_Competitors" MaintainScrollPositionOnPostback="true" %>
...
<div class="table-responsive" style="margin-left: -16px;">
   <p style="color:black;font-weight:bold;">IntelliSpace Portal Enterprise Software</p>
   <table class="table table-bordered">
      <thead>
         <tr>
            <th scope="col" style="background-color: #0b1f65;">Option Number</th>
            <th scope="col" style="background-color: #0b1f65;">Description</th>
            <th scope="col" style="background-color: #0b1f65;">Overall Quantity ( select in the tool )</th>
         </tr>
      </thead>
      <tbody>
         <tr>
            ...
            <td><%=m_centralised_concurrent_ent_users %> </td>
         </tr>
