<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MVMatrix-Edit.aspx.cs" Inherits="Admin_MVMatrix_Edit" %>
                                ...
                                <div class="row">
                                    <div class="user-profiles">
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 total-title">
                                            <h4>Edit MV Matrix - <% =cmdEditItem.SelectedValue%></h4>
                                        </div>
                                            ...
                                            <div class="add-section">
                                                <ul class="list-inline text-right">
                                                    <li>
                                                        ...
                                                        <asp:DropDownList ID="cmdEditItem" OnSelectedIndexChanged="cmdEditItem_SelectedIndexChanged" AutoPostBack="true" runat="server">
                                                            <asp:ListItem>Vendor</asp:ListItem>
                                                            <asp:ListItem>Model</asp:ListItem>
                                                            <asp:ListItem>Software</asp:ListItem>
                                                            <asp:ListItem>DataDef</asp:ListItem>
                                                            <asp:ListItem>ISP</asp:ListItem>
                                                            <asp:ListItem>Modality</asp:ListItem>
                                                ...
                                                <table width="100%" border="1" bordercolor="#ccc">
                                                    <thead>
                                                        <tr style="height: 42px;">
                                                            <th style="color:white;background:#012663 !important;" ><% =cmdEditItem.SelectedValue%></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <asp:Panel ID="PanelNewRow" runat="server">
                                                            <tr class="edit-rows">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtData1" Width="550" placeholder="Add new item" runat="server"></asp:TextBox>
                                                                </td>
                                                        ...
                                                        <asp:Repeater ID="repDataGrid" runat="server" OnItemCommand="repDataGrid_ItemCommand" OnItemDataBound="repDataGrid_ItemDataBound">
                                                            <ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtData" Width="550" runat="server"></asp:TextBox>
                                                                    </td>
