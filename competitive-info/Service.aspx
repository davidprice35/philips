<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Service.aspx.cs" Inherits="competitive_info_Competitors" %>
			...
			<div class="container">
				<div class="row">
						...
						<div class="col-sm-12 col-xs-12 col-md-2 col-lg-2">
                            <a href="/">
							<img src="/images/ServiceLogo.png"class="img-responsive">
                            </a>
						</div>
...
<div class="collapse navbar-collapse" id="myNavbar">
									<ul class="nav navbar-nav navbar-left">
                                        ...
                                        <li><asp:LinkButton ID="cmdServices" OnClick="cmdServices_Click" runat="server">Services</asp:LinkButton></li>   
                                         <% if (m_UserType == "Super Admin")
                                             {%>
                                         <li><asp:LinkButton ID="cmdEdit" OnClick="cmdEdit_Click"  runat="server">Edit</asp:LinkButton></li>
                                        <li><a href="/competitive-info/ServicePendingUpdates.aspx">Approve</a></li>
                                        <% } %>
						...
						<div class="left-sidebar camparision-section">
							...
							<div class="required-fields" id="demo1">
							 ...
							 <button class="btn-primary submit show-hide-btn" type="button"  >Matrix Filters</button>
                                ...
                                <div class="filterboxesselection">
							<div class="checkbox-body-part">
									<ul>
										 <li>
										...
										<li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkBusiness" type="checkbox" checked="">
												<label for="chkBusiness">
													Business Model
												</label>
											</div>
										</li>
										<li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkSupport" type="checkbox" checked="" >
										...
										<li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkRemote" type="checkbox" checked="">
												<label for="chkRemote">
													Remote Support
												</label>
											</div>
										...
										<li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkHour" type="checkbox" checked="">
												<label for="chkHour">
													Business Hour
												</label>
											</div>
										...
										<li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkCustomer" type="checkbox" checked="">
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkOnsite" type="checkbox" checked="">
												<label for="chkOnsite">
													Onsite assistance
												</label>
											</div>
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkSoftwareS" type="checkbox" checked="">
												<label for="chkSoftwareS">
													Software Services
												</label>
											</div>
										</li>
                                           ...
                                           <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkSWupdates" type="checkbox" checked="">
												<label for="chkSWupdates">
                                           ...
                                           <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkRemoteinstall" type="checkbox" checked="">
												<label for="chkRemoteinstall">
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkOnsiteIn" type="checkbox" checked="">
												<label for="chkOnsiteIn">
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkProactive" type="checkbox" checked="">
												<label for="chkProactive">
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkUptime" type="checkbox" checked="">
												<label for="chkUptime">
													Uptime
												</label>
											</div>
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkVirus" type="checkbox" checked="">
												<label for="chkVirus">
													Virus protection
												</label>
											</div>
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkUsage" type="checkbox" checked="">
												<label for="chkUsage">
													Usage analytics
												</label>
											</div>
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkEducation" type="checkbox" checked="">
												<label for="chkEducation">
													Education services
												</label>
											</div>
										</li>
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkClinicalIT" type="checkbox" checked="">
												<label for="chkClinicalIT">
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkEducationT" type="checkbox" checked="">
												<label for="chkEducationT">
													Education tools
												</label>
											</div>
										</li>
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkBusinessS" type="checkbox" checked="">
												<label for="chkBusinessS">
													Business Services
												</label>
											</div>
										</li>
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkRelease" type="checkbox" checked="">
												<label for="chkRelease">
													Release notes
												</label>
											</div>
										</li>
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkplanning" type="checkbox" checked="">
												<label for="chkplanning">
													Release planning
												</label>
											</div>
										</li>
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkReporting" type="checkbox" checked="">
												<label for="chkReporting">
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chksupportP" type="checkbox" checked="">
												<label for="chksupportP">
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkLifecycle" type="checkbox" checked="">
												<label for="chkLifecycle">
                                        ...
                                        <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkHardware" type="checkbox" checked="">
												<label for="chkHardware">
													Hardware Services
												</label>
											</div>
										</li>
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkMaintenance" type="checkbox" checked="">
												<label for="chkMaintenance">
                                         ...
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkHardwareR" type="checkbox" checked="">
												<label for="chkHardwareR">
													Hardware Refresh
												</label>
											</div>
										</li>
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkSolutionW" type="checkbox" checked="">
												<label for="chkSolutionW">
													Solution Weaknesses
												</label>
											</div>
										</li>
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkSolutionS" type="checkbox" checked="">
												<label for="chkSolutionS">
													Solution Strengths
												</label>
											</div>
										</li>
                                         <li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkCompetitive" type="checkbox" checked="">
												<label for="chkCompetitive">
								...
								<div class="tab-content toshiba-content " style="display:inline-block;width:1400px;">
									<div id="home" class="tab-pane fade in active">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function CheckFilterBoxes() {
                                                ...
                                                $(".filterboxesselection input[type=checkbox]").each(function()
                                                {
                                                    if ($(this)[0].checked == false) {
                                                        gridObj.getRowByIndex(idx).hide();
                                                    }
                                            ...
                                            $("#chkBusiness").change(function (e) {
                                              ...
                                              $("#chkSoftwareS").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                              ...
                                              $("#chkSWupdates").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                             ...
                                             $("#chkRemoteinstall").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                             ...
                                             $("#chkProactive").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                             ...
                                             $("#chkEducation").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(16).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(16).hide();
                                                 }
                                            });
                                             $("#chkClinicalIT").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(17).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(17).hide();
                                                 }
                                            });

                                             $("#chkEducationT").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(18).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(18).hide();
                                                 }
                                            });

                                             $("#chkBusinessS").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(19).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(19).hide();
                                                 }
                                            });
                                             $("#chkRelease").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(20).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(20).hide();
                                                 }
                                            });
                                             $("#chkplanning").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(21).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(21).hide();
                                                 }
                                            });
                                             $("#chkReporting").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(22).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(22).hide();
                                                 }
                                            });
                                             $("#chksupportP").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(23).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(23).hide();
                                                 }
                                            });
                                             $("#chkLifecycle").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(24).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(24).hide();
                                                 }
                                            });
                                             $("#chkHardware").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(25).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(25).hide();
                                                 }
                                            });
                                             $("#chkMaintenance").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(26).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(26).hide();
                                                 }
                                            });
                                             $("#chkHardwareR").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(27).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(27).hide();
                                                 }
                                            });
                                             $("#chkSolutionW").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(28).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(28).hide();
                                                 }
                                            });
                                             $("#chkSolutionS").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(29).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(29).hide();
                                                 }
                                            });
                                             $("#chkCompetitive").change(function (e) {
                                                 var gridObj = $("#Grid1").ejGrid("instance"); 
                                                 if ($(this).is(":checked")) {
                                                     gridObj.getRowByIndex(30).show();
                                                 }
                                                 else
                                                 {
                                                     
                                                     gridObj.getRowByIndex(30).hide();
                                                 }
                                            });
									...
									<div style="margin-top: 30px;height:660px;">
                                       ...
                                       <ej:Grid ID="Grid1" runat='server' MinWidth="400" Width="1380" Height="580"  AllowScrolling="true" OnServerBatchEditRow="EditEvents_ServerEditRow" OnServerEditRow="EditEvents_ServerEditRow"  AllowTextWrap="true" AllowResizing="true" IsResponsive="false">
                                            ...
                                            <ClientSideEvents DataBound="createEvent" QueryCellInfo="GridQueryCellInfoEvent"  ActionComplete="complete" />
                                         ...
                                         <script type="text/javascript">    
                                            ...
                                            { 
                                              ...
                                              function GridQueryCellInfoEvent(args) { 
                                                  ...
                                                  if (args.column.field != "ColumnName" && args.rowData.ColumnName != "Solution") { 
                                                  ...
                                                  if (args.rowData.ColumnName == "Software Services") {                                                       
                                                        $(args.cell).css("backgroundColor", "#ed7d31").css("color", "#000000"); 
                                                  }

                                                  if (args.rowData.ColumnName == "Support Services") {
                                                       // $(args.cell).css('font-weight', 'bold');
                                                        $(args.cell).css("backgroundColor", "#ed7d31").css("color", "#000000"); 
                                                  }

                                                  if (args.rowData.ColumnName == "Business Services") {
                                                       // $(args.cell).css('font-weight', 'bold');
                                                        $(args.cell).css("backgroundColor", "#ed7d31").css("color", "#000000"); 
                                                  }

                                                  if (args.rowData.ColumnName == "Education Services") {                                                     
                                                     $(args.cell).css("backgroundColor", "#ed7d31").css("color", "#000000"); 
                                                  }

                                                  if (args.rowData.ColumnName == "Hardware Services") {                                                    
                                                    $(args.cell).css("backgroundColor", "#ed7d31").css("color", "#000000"); 
                                                  }
                                            ...
                                            function Philipswrite(args) {
                                                ...
                                                //$(args.element.parents('td')[0]).append('<input type="radio" name="Philipscheck" id="PhilipscheckboxNone" value="3"><label for="PhilipscheckboxNone">None</label><br/>');
