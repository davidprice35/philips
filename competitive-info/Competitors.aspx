<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Competitors.aspx.cs" Inherits="competitive_info_Competitors" %>
							...
							<nav class="navbar navbar-inverse">
                                ...
                                <div class="collapse navbar-collapse" id="myNavbar">
									<ul class="nav navbar-nav navbar-left">
                                        ...
                                        <li><a href="/competitive-info/Competitors">Competitors</a></li>    
                                        <% if (m_UserType == "Super Admin")
                                            {%>
                                        <li><asp:LinkButton ID="cmdEdit" OnClick="cmdEdit_Click"  runat="server">Edit</asp:LinkButton></li>                                        
                                        <li><a href="/competitive-info/CompPendingUpdates.aspx">Approve</a></li>
                                        <%} %>
							...
							<div class="required-fields" id="demo1">
								<div class="checkbox-body-part">
									<ul>
                                        ...
                                        <%--<li>											
											<div class="checkbox checkbox-primary">
												<input id="chkPhilipsFreeze" type="checkbox" >
												<label for="chkPhilipsFreeze" class="philips">
													Philips Freeze
												</label>
											</div>
										</li> --%>
							...
							<div class="checkbox-body-part">
									<ul>
										...
										<li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkMarket" type="checkbox" checked="">
												<label for="chkMarket">
													Market Share
												</label>
											</div>
										...
										<li>
											...
											<div class="checkbox checkbox-primary">
												<input id="chkSolution" type="checkbox" checked="">
												<label for="chkSolution">
													Solution Weaknesses
												</label>
											</div>
										</li>
						...
						<div class="col-lg-12 col-md-12 col-sm-9 right-padding">
							<div class="rightbar">
								<ul class="nav nav-tabs">
									  <li class="active"><a href="Competitors.aspx">competitors</a></li>
								...
								<div class="tab-content toshiba-content " style="display:inline-block;width:1400px;">
									<div id="home" class="tab-pane fade in active">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            //document.getElementById("chkPhilips").checked = true; 
                                            //document.getElementById("#chkTera").checked = true;
                                            //document.getElementById("#chkSiemens").checked = true;
                                            //document.getElementById("#chkGE").checked = true;
                                            //document.getElementById("#chkCanon").checked = true;
                                            //document.getElementById("#chkAgfa").checked = true;
									...
									<div style="margin-top: 30px;height:660px;">
                                                         <div id="scroll"></div>
                                        <ej:Grid ID="Grid1" runat='server' MinWidth="400" Width="1380" Height="580" AllowSelection="true" AllowScrolling="true" OnServerEditRow="EditEvents_ServerEditRow"  AllowTextWrap="true" AllowResizing="true" IsResponsive="false">
                                            ...
                                            <Columns>
                                                ...
                                                <ej:Column Field="Philips" Width="350" HeaderText="Philips" CssClass="Philips" HeaderTextAlign="center" DisableHtmlEncode="false"  HeaderTemplateID="#PhilipsHeader"  >                                                
                                                 ...
                                                 <ej:Column Field="Tera" Width="350" HeaderText="Tera" CssClass="Tera" HeaderTextAlign="center" DisableHtmlEncode="false" HeaderTemplateID="#TeraHeader"   >                                                
                                                    <EditTemplate Create="create" Read="Teraread" Write="Terawrite" />
                                                </ej:Column>

                                                <ej:Column Field="Siemens" Width="350" HeaderText="Siemens" CssClass="Siemens" HeaderTextAlign="center" DisableHtmlEncode="false" HeaderTemplateID="#SiemensHeader"   >                                                
                                                    <EditTemplate Create="create" Read="Siemensread" Write="Siemenswrite" />
                                                </ej:Column>

                                                <ej:Column Field="GE" Width="350" HeaderText="GE"  CssClass="GE" HeaderTextAlign="center" DisableHtmlEncode="false" HeaderTemplateID="#GEHeader"  >                                                
                                                    <EditTemplate Create="create" Read="GEread" Write="GEwrite" />
                                                </ej:Column>

                                                <ej:Column Field="Cannon" Width="350" CssClass="Cannon"  HeaderText="Canon/Toshiba/Vital" DisableHtmlEncode="false"  HeaderTextAlign="center" HeaderTemplateID="#Cannon" >                                                
                                                    <EditTemplate Create="create" Read="Cannonread" Write="Cannonwrite" />
                                                </ej:Column>

                                                <ej:Column Field="Agfa" Width="350" CssClass="Agfa" HeaderText="Agfa Healthcare" DisableHtmlEncode="false"  HeaderTextAlign="center" HeaderTemplateID="#Agfa"  >                                                
