<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClinicalPendingUpdates.aspx.cs" Inherits="Admin_EditGridData" ValidateRequest="false" %>
						...
						<div class="col-lg-9 col-md-9 col-sm-9 right-padding">
							<div class="rightbar">
								<ul class="nav nav-tabs">
									  <li class="active"><a data-toggle="tab" href="#home">Clinical</a></li>
                                        ...
                                        <asp:Repeater ID="repDataGrid" runat="server" OnItemDataBound="repDataGrid_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <table width='1170px' border="1" cellpadding='0' cellspacing='0' class='table1'>
                                                    ...
                                                    <asp:HiddenField ID="HF_PhilipsAnalysisCompetitorsPendingUpdatesID" runat="server" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <asp:TextBox ID="txtNew" Height="124" Width="240" runat="server" TextMode="MultiLine"></asp:TextBox> </td>
                                                        <td> <asp:TextBox ID="txtCurrent" Height="124" Width="240" TextMode="MultiLine" runat="server"></asp:TextBox> </td>
                                                        <td>                                                              
