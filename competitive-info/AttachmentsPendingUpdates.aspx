<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AttachmentsPendingUpdates.aspx.cs" Inherits="Admin_EditGridData" ValidateRequest="false" %>
						...
						<div class="col-lg-9 col-md-9 col-sm-9 right-padding">
							<div class="rightbar">
								<ul class="nav nav-tabs">
									  <li class="active"><a data-toggle="tab" href="#home">Attachments</a></li>
                                        ...
                                        <asp:Repeater ID="repDataGrid" runat="server" OnItemDataBound="repDataGrid_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <table width='1170px' border="1" cellpadding='0' cellspacing='0' class='table1'>
                                                    ...
                                                    <asp:HiddenField ID="HF_PhilipsAttachmentsPendingID" runat="server" />
                                            

                                                    <th width="64" class=''></th>
                                                    <th width="252" class=''>New</th>
                                                    <th width="211" class=''>Current</th>
                                                    <th width="641" class=''>Details</th>
                                                    <tr>
