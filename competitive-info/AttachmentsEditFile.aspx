<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AttachmentsEditFile.aspx.cs" Inherits="competitive_info_AttachmentsEdit" %>
						...
						<div class="col-lg-10 col-sm-9 col-md-9 right-padding competitors-right">
							<div class="rightbar">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active"><a href="Attachments.aspx">attachments Edit</a></li>
                                </ul>
									...
									<div id="menu4" class="tab-pane fade in active">
										<div class="clinical-preview">
											<div class="col-sm-12 col-md-12">
                                                ...
                                                <table width='950px'class='table1' cellpadding='0'cellspacing='0'>
                                                    <tr>                                                    
                                                    <th>Name</th>
                                                    <th>Type</th>
                                                    <th>File Name</th>                                                                                                                                                                                                                
                                                    ...
                                                    <asp:HiddenField ID="hid_FileAttachmentListID" runat="server" />
                                                        
                                                    <tr style="background-color:lightblue">
                                                   
                                                        <asp:Panel ID="panAddNew" runat="server">
                                                         <td class=''><asp:DropDownList ID="cboName1" runat="server"></asp:DropDownList></td>
                                                         <td class=''><asp:DropDownList ID="cboType1" runat="server"></asp:DropDownList></td>
                                                        </asp:Panel>

                                                        <asp:Panel ID="panEdit" runat="server">
                                                        <td class=''><asp:TextBox ReadOnly="true" ID="txtName" runat="server"></asp:TextBox></td>
                                                        <td class=''><asp:TextBox ReadOnly="true" ID="txtType" runat="server"></asp:TextBox></td>
                                                        </asp:Panel>

                                                        <td class=''><asp:TextBox ID="txtFileName" Width="400" runat="server"></asp:TextBox></td>
                                                        <td class=''>
                                                            <asp:Button ID="cmdUpdate" runat="server" OnClick="cmdUpdate_Click"  Text="Save" />
                                                            ...
                                                            <ej:UploadBox ID="Upload1" ClientSideOnSuccess="fileuploadSuccess" runat="server" SaveUrl="saveFiles.ashx"  RemoveUrl="removeFiles.ashx"></ej:UploadBox>
                                                        </td>
